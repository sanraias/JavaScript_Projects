...
let activePlayer = "X";
// This array stores abn array moves. We use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "O") {
            ...
            disableClick();
            //This function waits 1 second before the computer places an image and enabñes click.
...
function checkWinConditions() {
    ...
    //9 squares are selected the code executes.
        ...
        audio('./media/magic.mp3');
        //This function sets a .3 second timer before the resetGame is called.
        setTimeout(function() {resetGame();},500);
    }

    //This function checls if an array includes 3 strings. It is used to check for
    //each condition.
