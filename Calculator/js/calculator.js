...
//This modifices values each time a button is clicked on.
...
function Input_Decimal (dot) {
    //This ensures that accodental clicking of the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    } else if (operator) {//Checks if an operator already existes
        const Value_Now = First_Operand || 0;
        //If operator existes, property lookup is performed for the operator
